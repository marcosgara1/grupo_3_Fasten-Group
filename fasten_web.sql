...
--
-- Host: localhost    Database: fasten_web
-- ------------------------------------------------------
...
CREATE TABLE `products` (
  ...
  `descriptionSeg` varchar(100) DEFAULT NULL,
  `foto` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `clasificacion_id` FOREIGN KEY (`id`) REFERENCES `clasificacion` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-06-09 19:46:58
